...
/**
 * This class contains reference matrixes for AES Encryption.
 * @author Sudipta Saha
 * @version 1.2
 * @since 28/06/17
 */
class ReferenceBytes {
    ...
    final static byte inverse_sbox[][]={
    ...
    final static byte mixColumnMatrix[][]={
        {0x02,   0x03, 0x01, 0x01},
        {0x01,   0x02, 0x03, 0x01},
        {0x01,   0x01, 0x02, 0x03},
        {0x03,   0x01, 0x01, 0x02}
    ...
    final static byte inverse_mixColumnMatrix[][]={
        {0x0e,   0x0b, 0x0d, 0x09},
        {0x09,   0x0e, 0x0b, 0x0d},
        {0x0d,   0x09, 0x0e, 0x0b},
        {0x0b,   0x0d, 0x09, 0x0e}
